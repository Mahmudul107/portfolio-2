    ...
    <div>
      <div className="hero min-h-screen">
        <div className="hero-content flex-col lg:flex-row-reverse">
          <div className="bg-lime-500 w-[380px] h-96 rounded-full hover:scale-90 transition-transform hover:translate-x-4 duration-700">
            <div className="">
              <img
                className="flex justify-center rounded-full w-[380px] h-96"
                src={cover}
              />
            </div>
          </div>
