    ...
    <div>
      ...
      <div className="card lg:card-side mx-auto lg:flex-row-reverse justify-center gap-32">
        <div className="mt-8">
          ...
          <Link className="relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-white rounded hover:bg-white group mt-24 ml-24 lg:ml-40">
