      ...
      <div className="card lg:card-side mx-auto lg:flex-row-reverse justify-center gap-32">
        ...
        >
          ...
          <a
            href={pdf}
            download
            className="relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-white rounded hover:bg-[#84cc16] group mt-24 ml-24 lg:ml-40"
          >
            <span className="w-48 h-48 rounded rotate-[-40deg] bg-[#84cc16] absolute bottom-0 left-0 -translate-x-full ease-out duration-500 transition-all translate-y-full mb-9 ml-9 group-hover:ml-0 group-hover:mb-32 group-hover:translate-x-0"></span>
        ...
        <div
          ...
          data-aos-duration="1000"
        >
          <p className="text-[#e2e8f0] font-sans text-base md:text-lg">
          ...
          <div className="flex flex-col md:flex-row shadow-[#84cc16] shadow-2xl rounded-lg gap-4 mt-4 p-6 md:p-10">
            <div className="mr-8">
              ...
              <h2 className="text-[#e2e8f0] mb-4">1205-Dhaka, Bangladesh</h2>
            </div>
            <div className="border border-[#06b6d4] my-4 md:my-0"></div>
            <div>
              <p className="text-[#e2e8f0] text-base md:text-lg">Education</p>
              <h2 className="text-[#e2e8f0] mb-4">
                BA in Sociology (2019-2024)
              </h2>
              <p className="text-[#e2e8f0] text-base md:text-lg">CGPA</p>
              <h2 className="text-[#e2e8f0] mb-4">3.07</h2>
              <p className="text-[#e2e8f0] text-base md:text-lg">Institution</p>
              <h2 className="text-[#e2e8f0] mb-4">Dhaka College</h2>
              <p className="text-[#e2e8f0] text-base md:text-lg">Language</p>
              <h2 className="text-[#e2e8f0] mb-4">Bangla, English</h2>
            </div>
          </div>
        </div>
      </div>
